    ...
    onSubmitSignIn = () => {
        fetch("http://localhost:3000/register", {
            ...
            .then(user => {
                ...
                } else if (this.state.invalidRegister === ""){
                    this.setState({invalidRegister: "ERROR: Unable to Register"})
                    setTimeout(() => {
                        this.setState({invalidRegister: ""})
                    },3000)
                }
            })
    }
                ...
                <main className="pa4 black-80">
                    <div className="measure">
                        ...
                        <div className="mt3">
                            ...
                            <input onChange={this.onNameChange} className="pa2 input-reset ba bg-transparent hover-bg-green hover-white w-100" type="text" name="name"  id="name"/>
                        </div>
                        <div className="mt3">
                        ...
                        <div className="">
                            ...
                            <p className="f7 red db">{this.state.invalidRegister}</p>
                        </div>
                    </div>
                </main>
            </article>
